...
const PAGE_DATES: Record<string, string> = {
  ...
  "/gold": "2026-01-26",
  "/gold-and-silver-prices": "2026-01-28",
  "/silver-price-usd": "2026-01-28",
  "/shanghai-silver-price": "2026-01-26",
  "/shanghai-silver-price-in-usd": "2026-02-11",
  "/shanghai-silver-price-per-ounce": "2026-02-11",
  "/shanghai-vs-comex-silver-premium": "2026-02-11",
  "/shfe-silver-price-today": "2026-02-11",
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    {
      url: `${baseUrl}/gold-and-silver-prices`,
      lastModified: PAGE_DATES["/gold-and-silver-prices"] || currentDate,
      changeFrequency: "hourly",
      priority: 0.95, // High priority - major traffic page
    },
    {
      url: `${baseUrl}/silver-price-usd`,
      lastModified: PAGE_DATES["/silver-price-usd"] || currentDate,
      changeFrequency: "hourly",
      priority: 0.95, // High priority - US/global traffic target
    },
    {
    ...
    {
      url: `${baseUrl}/shanghai-silver-price-in-usd`,
      lastModified: PAGE_DATES["/shanghai-silver-price-in-usd"] || currentDate,
      changeFrequency: "hourly",
      priority: 0.92,
    },
    {
      url: `${baseUrl}/shanghai-silver-price-per-ounce`,
      lastModified: PAGE_DATES["/shanghai-silver-price-per-ounce"] || currentDate,
      changeFrequency: "hourly",
      priority: 0.92,
    },
    {
      url: `${baseUrl}/shanghai-vs-comex-silver-premium`,
      lastModified: PAGE_DATES["/shanghai-vs-comex-silver-premium"] || currentDate,
      changeFrequency: "hourly",
      priority: 0.93,
    },
    {
      url: `${baseUrl}/shfe-silver-price-today`,
      lastModified: PAGE_DATES["/shfe-silver-price-today"] || currentDate,
      changeFrequency: "hourly",
      priority: 0.9,
    },
    {
